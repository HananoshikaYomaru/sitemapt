...
/* @internal */
export const die = defect => failCauseAnnotate(annotate => annotate(internalCause.die(defect)));
/* @internal */
...
/* @internal */
export const fail = error => failCauseAnnotate(annotate => annotate(internalCause.fail(error)));
/* @internal */
...
/* @internal */
export const failCauseAnnotate = evaluate => {
...
/** @internal */
export const currentMaxOpsBeforeYield = /*#__PURE__*/fiberRefUnsafeMake(2048);
/** @internal */
