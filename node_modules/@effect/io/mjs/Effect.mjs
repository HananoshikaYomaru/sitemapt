 ...
 * @category constructors
 */
export const failCauseAnnotate = core.failCauseAnnotate;
/**
 * @since 1.0.0
 * @category constructors
 */
 ...
 * @category scheduler
 */
export const setScheduler = scheduler => layer.scopedDiscard(fiberRuntime.fiberRefLocallyScoped(Scheduler.currentScheduler, scheduler));
/**
