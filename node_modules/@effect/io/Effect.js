...
var circularLayer = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("@effect/io/internal/layer/circular"));
var query = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("@effect/io/internal/query"));
var _runtime = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("@effect/io/internal/runtime"));
var _schedule = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("@effect/io/internal/schedule"));
var RuntimeFlags = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("@effect/io/RuntimeFlags"));
...
const failCauseAnnotate = core.failCauseAnnotate;
/**
 * @since 1.0.0
 * @category constructors
 */
...
const withScheduler = Scheduler.withScheduler;
/**
...
const provideSomeRuntime = /*#__PURE__*/(0, _Function.dual)(2, (self, runtime) => {
  ...
  return acquireUseRelease(core.flatMap(patchRuntimeFlags(patchFlags), () => patchFiberRefs(patchRefs)), () => provideSomeContext(self, runtime.context), () => core.flatMap(patchRuntimeFlags(inversePatchFlags), () => patchFiberRefs(inversePatchRefs)));
});
/**
...
const getFiberRefs = effect.fiberRefs;
/**
