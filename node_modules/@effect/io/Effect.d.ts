...
import type { LogLevel } from "@effect/io/LogLevel";
 ...
 * @category constructors
 */
export declare const failCauseAnnotate: <E>(evaluate: (annotate: <X>(cause: Cause.Cause<X>) => Cause.Cause<X>) => Cause.Cause<E>) => Effect<never, E, never>;
/**
 * @since 1.0.0
 * @category constructors
 */
...
export declare const linkSpans: {
    (span: Tracer.ParentSpan, attributes?: Record<string, Tracer.AttributeValue>): <R, E, A>(self: Effect<R, E, A>) => Effect<R, E, A>;
    <R, E, A>(self: Effect<R, E, A>, span: Tracer.ParentSpan, attributes?: Record<string, Tracer.AttributeValue>): Effect<R, E, A>;
};
/**
