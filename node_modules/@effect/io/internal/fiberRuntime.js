...
var _console = /*#__PURE__*/require("@effect/io/internal/defaultServices/console");
...
const fiberLifetimes = /*#__PURE__*/metric.tagged( /*#__PURE__*/metric.histogram("effect_fiber_lifetimes", /*#__PURE__*/metricBoundaries.exponential({
  start: 1.0,
  factor: 1.3,
  count: 100
...
class FiberRuntime {
  ...
  [OpCodes.OP_FAILURE_WITH_ANNOTATION](op) {
    ...
    const cause = List.isNil(span) || span.head._tag === "ExternalSpan" ? op.i0(_Function.identity) :
    // @ts-expect-error
...
const replicateEffect = /*#__PURE__*/(0, _Function.dual)(args => core.isEffect(args[0]), (self, n, options) => all(replicate(self, n), options));
// @ts-expect-error
