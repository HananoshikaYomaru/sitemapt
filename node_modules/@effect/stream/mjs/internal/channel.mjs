...
/** @internal */
export const acquireUseRelease = (acquire, use, release) => core.flatMap(core.fromEffect(Ref.make(() => Effect.unit)), ref => core.ensuringWith(exit => Effect.flatMap(Ref.get(ref), f => f(exit)))(core.flatMap(use)(core.fromEffect(Effect.uninterruptible(Effect.tap(acquire, a => Ref.set(ref, exit => release(a, exit))))))));
/** @internal */
...
/** @internal */
export const contramap = /*#__PURE__*/dual(2, (self, f) => {
...
/** @internal */
export const contramapEffect = /*#__PURE__*/dual(2, (self, f) => {
  const reader = core.readWith({
    onInput: inElem => core.flatMap(core.write(inElem), () => reader),
    onFailure: core.fail,
...
/** @internal */
export const contramapError = /*#__PURE__*/dual(2, (self, f) => {
  const reader = core.readWith({
    onInput: inElem => core.flatMap(core.write(inElem), () => reader),
...
/** @internal */
export const contramapErrorEffect = /*#__PURE__*/dual(2, (self, f) => {
  const reader = core.readWith({
    onInput: inElem => core.flatMap(core.write(inElem), () => reader),
...
/** @internal */
export const contramapIn = /*#__PURE__*/dual(2, (self, f) => {
  const reader = core.readWith({
...
export const contramapInEffect = /*#__PURE__*/dual(2, (self, f) => {
  const reader = core.readWith({
...
/** @internal */
export const fromHub = hub => unwrapScoped(Effect.map(Hub.subscribe(hub), fromQueue));
/** @internal */
export const fromHubScoped = hub => Effect.map(Hub.subscribe(hub), fromQueue);
/** @internal */
...
/** @internal */
export const mapOutEffectPar = /*#__PURE__*/dual(3, (self, f, n) => unwrapScoped(Effect.map(queue => {
...
export const mergeAllWith = ({
  ...
  const errorSignal = yield* $(Deferred.make());
  const withPermits = concurrency === "unbounded" ? _ => identity : (yield* $(Effect.makeSemaphore(concurrency))).withPermits;
...
/** @internal */
export const contramapContext = /*#__PURE__*/dual(2, (self, f) => contextWithChannel(context => core.provideContext(self, f(context))));
/** @internal */
...
/** @internal */
export const toHub = hub => toQueue(hub);
/** @internal */
...
/** @internal */
export const updateService = /*#__PURE__*/dual(3, (self, tag, f) => contramapContext(self, context => Context.merge(context, Context.make(tag, f(Context.unsafeGet(context, tag))))));
/** @internal */
export const withSpan = /*#__PURE__*/dual(3, (self, name, options) => unwrapScoped(Effect.as(Effect.withSpanScoped(name, options), self)));
/** @internal */
