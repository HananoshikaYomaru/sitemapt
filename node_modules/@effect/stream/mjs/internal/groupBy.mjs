...
/** @internal */
export const evaluateBuffer = /*#__PURE__*/dual(3, (self, f, bufferSize) => stream.flatMap(self.grouped, ([key, queue]) => f(key, stream.flattenTake(stream.fromQueue(queue, {
  shutdown: true
}))), {
...
/** @internal */
export const groupBy = /*#__PURE__*/dual(args => typeof args[0] !== "function", (self, f, options) => make(stream.unwrapScoped(Effect.gen(function* ($) {
