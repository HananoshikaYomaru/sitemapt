...
const branchAfter = /*#__PURE__*/(0, _Function.dual)(3, (self, n, f) => suspend(() => {
  const buffering = acc => core.readWith({
    onInput: input => {
      ...
      return buffering(Chunk.appendAll(input)(acc));
    },
    onFailure: core.fail,
  ...
  return new StreamImpl(channel.pipeToOrFail(buffering(Chunk.empty()))(toChannel(self)));
}));
/** @internal */
...
const mapBoth = /*#__PURE__*/(0, _Function.dual)(2, (self, options) => map(options.onSuccess)(mapError(options.onFailure)(self)));
/** @internal */
...
const prepend = /*#__PURE__*/(0, _Function.dual)(2, (self, values) => new StreamImpl(channel.zipRight(core.write(values), toChannel(self))));
/** @internal */
...
const tapBoth = /*#__PURE__*/(0, _Function.dual)(2, (self, {
  onFailure,
  onSuccess
}) => tap(onSuccess)(tapError(onFailure)(self)));
/** @internal */
...
const tapErrorCause = /*#__PURE__*/(0, _Function.dual)(2, (self, f) => {
  const loop = core.readWithCause({
...
const decodeText = /*#__PURE__*/(0, _Function.dual)(args => isStream(args[0]), (self, encoding = "utf-8") => suspend(() => {
