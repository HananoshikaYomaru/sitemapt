...
/** @internal */
export const isSTM = u => typeof u === "object" && u != null && STMTypeId in u;
/** @internal */
...
/** @internal */
export const dieMessage = message => dieSync(() => Cause.RuntimeException(message));
/** @internal */
...
/** @internal */
export const map = /*#__PURE__*/dual(2, (self, f) => flatMap(a => sync(() => f(a)))(self));
/** @internal */
...
/** @internal */
export const zip = /*#__PURE__*/dual(2, (self, that) => zipWith(that, (a, a1) => [a, a1])(self));
/** @internal */
export const zipLeft = /*#__PURE__*/dual(2, (self, that) => flatMap(a => map(() => a)(that))(self));
/** @internal */
export const zipRight = /*#__PURE__*/dual(2, (self, that) => flatMap(() => that)(self));
/** @internal */
export const zipWith = /*#__PURE__*/dual(3, (self, that, f) => flatMap(a => map(b => f(a, b))(that))(self));
